...
const getAllSemesters = (fillters, paginationOptions) => __awaiter(void 0, void 0, void 0, function* () {
    const { searchTerm } = fillters, fillterData = __rest(fillters, ["searchTerm"]);
    const andCondition = [];
    if (searchTerm) {
        andCondition.push({
